...
public final class ItemBillBinding implements ViewBinding {
  ...
  private ItemBillBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivReceipt,
  ...
  public static ItemBillBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemBillBinding((ConstraintLayout) rootView, ivReceipt, tvAmount, tvCategory,
          tvNote, tvTime);
    }
