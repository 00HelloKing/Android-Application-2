...
public final class FragmentStatsBinding implements ViewBinding {
  ...
  private FragmentStatsBinding(@NonNull ConstraintLayout rootView, @NonNull PieChart pieChart,
      @NonNull RecyclerView recyclerCategories, @NonNull TextView tvMonth) {
  ...
  public static FragmentStatsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentStatsBinding((ConstraintLayout) rootView, pieChart, recyclerCategories,
          tvMonth);
    }
